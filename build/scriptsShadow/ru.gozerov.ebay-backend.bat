...
set CLASSPATH=%APP_HOME%\lib\ru.gozerov.ebay-backend-all.jar

@rem Execute ru.gozerov.ebay-backend
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %RU_GOZEROV_EBAY_BACKEND_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%RU_GOZEROV_EBAY_BACKEND_EXIT_CONSOLE%" exit 1
exit /b 1
